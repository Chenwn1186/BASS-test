/*
	...
	Copyright (c) 2002-2023 Un4seen Developments Ltd.
*/
...
HSTREAM instream;		// input stream
HSTREAM inmixer;		// mixer for resampling input

int outdev = -1;			// output device
HSTREAM outstream;	// playback stream
HSTREAM outmixer;		// mixer for resampling output

char *recbuf;		// recording buffer
DWORD reclen;			// recording length

float inlevel;		// input level
