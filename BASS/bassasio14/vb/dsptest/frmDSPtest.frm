...
Private Sub Form_Load()
    ...
    If (BASS_ASIO_Init(-1, 0) = BASSFALSE) Then
        Call BASS_Free
...
Private Sub cmdOpen_Click()
    ...
    BASS_ASIO_ChannelEnableBASS(BASSFALSE, 0, chan, BASSTRUE)
    Call BASS_ASIO_SetRate(info.freq) 'try to set the device rate to avoid resampling
